...
const lineColorValue = document.querySelector('#line-color-value');
...
lineColor.addEventListener('input', () => { lineColorValue.value = lineColor.value.toUpperCase(); lineColorValue.textContent = lineColor.value.toUpperCase(); });
